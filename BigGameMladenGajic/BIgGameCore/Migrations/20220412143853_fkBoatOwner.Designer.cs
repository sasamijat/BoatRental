...
namespace BIgGameCore.Migrations
{
    ...
    [Migration("20220412143853_fkBoatOwner")]
    partial class fkBoatOwner
    {
            ...
            modelBuilder.Entity("BigGame.Models.BoatAvailability", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 19, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(5636),
                            Location = "Budva",
                            Price = 35.5f,
                            StartDate = new DateTime(2022, 4, 12, 16, 38, 52, 534, DateTimeKind.Local).AddTicks(53)
                        },
                        new
                        {
                            BoatAvailabilityID = 2,
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 26, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(7097),
                            Location = "Budva",
                            Price = 40.5f,
                            StartDate = new DateTime(2022, 4, 19, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(7082)
                        },
                        new
                        {
                            BoatAvailabilityID = 3,
                            BoatID = 4,
                            EndDate = new DateTime(2022, 4, 19, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(7106),
                            Location = "Budva",
                            Price = 15.5f,
                            StartDate = new DateTime(2022, 4, 12, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(7103)
                        },
                        new
                        {
                            BoatAvailabilityID = 4,
                            BoatID = 3,
                            EndDate = new DateTime(2022, 4, 19, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(7112),
                            Location = "Herceg Novi",
                            Price = 20f,
                            StartDate = new DateTime(2022, 4, 12, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(7109)
                        },
                        new
                        {
                            BoatAvailabilityID = 5,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 19, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(7118),
                            Location = "Herceg Novi",
                            Price = 37f,
                            StartDate = new DateTime(2022, 4, 12, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(7115)
                        },
                        new
                        {
                            BoatAvailabilityID = 6,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 29, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(7124),
                            Location = "Budva",
                            Price = 55.2f,
                            StartDate = new DateTime(2022, 4, 19, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(7121)
                        });
                });
            ...
            modelBuilder.Entity("BigGame.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatAvailabilityID = 1,
                            UserID = 1,
                            endDateTime = new DateTime(2022, 4, 14, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(9093),
                            startDateTime = new DateTime(2022, 4, 13, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(8785)
                        },
                        new
                        {
                            ReservationID = 2,
                            BoatAvailabilityID = 3,
                            UserID = 2,
                            endDateTime = new DateTime(2022, 4, 14, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(9398),
                            startDateTime = new DateTime(2022, 4, 13, 16, 38, 52, 536, DateTimeKind.Local).AddTicks(9389)
                        });
                });
