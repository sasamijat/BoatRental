...
namespace BIgGameCore.Migrations
{
    ...
    [Migration("20220408124028_VirtualBoatToBA")]
    partial class VirtualBoatToBA
    {
            ...
            modelBuilder.Entity("BigGame.Models.BoatAvailability", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 15, 14, 40, 28, 235, DateTimeKind.Local).AddTicks(2246),
                            Location = "Budva",
                            Price = 35.5f,
                            StartDate = new DateTime(2022, 4, 8, 14, 40, 28, 232, DateTimeKind.Local).AddTicks(7006)
                        },
                        new
                        {
                            BoatAvailabilityID = 2,
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 22, 14, 40, 28, 235, DateTimeKind.Local).AddTicks(3680),
                            Location = "Budva",
                            Price = 40.5f,
                            StartDate = new DateTime(2022, 4, 15, 14, 40, 28, 235, DateTimeKind.Local).AddTicks(3666)
                        },
                        new
                        {
                            BoatAvailabilityID = 3,
                            BoatID = 4,
                            EndDate = new DateTime(2022, 4, 15, 14, 40, 28, 235, DateTimeKind.Local).AddTicks(3744),
                            Location = "Budva",
                            Price = 15.5f,
                            StartDate = new DateTime(2022, 4, 8, 14, 40, 28, 235, DateTimeKind.Local).AddTicks(3741)
                        },
                        new
                        {
                            BoatAvailabilityID = 4,
                            BoatID = 3,
                            EndDate = new DateTime(2022, 4, 15, 14, 40, 28, 235, DateTimeKind.Local).AddTicks(3751),
                            Location = "Herceg Novi",
                            Price = 20f,
                            StartDate = new DateTime(2022, 4, 8, 14, 40, 28, 235, DateTimeKind.Local).AddTicks(3748)
                        },
                        new
                        {
                            BoatAvailabilityID = 5,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 15, 14, 40, 28, 235, DateTimeKind.Local).AddTicks(3757),
                            Location = "Herceg Novi",
                            Price = 37f,
                            StartDate = new DateTime(2022, 4, 8, 14, 40, 28, 235, DateTimeKind.Local).AddTicks(3754)
                        },
                        new
                        {
                            BoatAvailabilityID = 6,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 25, 14, 40, 28, 235, DateTimeKind.Local).AddTicks(3762),
                            Location = "Budva",
                            Price = 55.2f,
                            StartDate = new DateTime(2022, 4, 15, 14, 40, 28, 235, DateTimeKind.Local).AddTicks(3760)
                        });
                });
