...
namespace BIgGameCore.Migrations
{
    ...
    [Migration("20220408145340_addReservation")]
            ...
            modelBuilder.Entity("BigGame.Models.BoatAvailability", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 15, 16, 53, 39, 660, DateTimeKind.Local).AddTicks(8116),
                            Location = "Budva",
                            Price = 35.5f,
                            StartDate = new DateTime(2022, 4, 8, 16, 53, 39, 656, DateTimeKind.Local).AddTicks(5252)
                        },
                        new
                        {
                            BoatAvailabilityID = 2,
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 22, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(1270),
                            Location = "Budva",
                            Price = 40.5f,
                            StartDate = new DateTime(2022, 4, 15, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(1241)
                        },
                        new
                        {
                            BoatAvailabilityID = 3,
                            BoatID = 4,
                            EndDate = new DateTime(2022, 4, 15, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(1288),
                            Location = "Budva",
                            Price = 15.5f,
                            StartDate = new DateTime(2022, 4, 8, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(1283)
                        },
                        new
                        {
                            BoatAvailabilityID = 4,
                            BoatID = 3,
                            EndDate = new DateTime(2022, 4, 15, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(1306),
                            Location = "Herceg Novi",
                            Price = 20f,
                            StartDate = new DateTime(2022, 4, 8, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(1298)
                        },
                        new
                        {
                            BoatAvailabilityID = 5,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 15, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(1324),
                            Location = "Herceg Novi",
                            Price = 37f,
                            StartDate = new DateTime(2022, 4, 8, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(1316)
                        },
                        new
                        {
                            BoatAvailabilityID = 6,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 25, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(1342),
                            Location = "Budva",
                            Price = 55.2f,
                            StartDate = new DateTime(2022, 4, 15, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(1333)
                        });
                });
            ...
            modelBuilder.Entity("BigGame.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatAvailabilityID = 1,
                            UserID = 1,
                            endDateTime = new DateTime(2022, 4, 10, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(5415),
                            startDateTime = new DateTime(2022, 4, 9, 16, 53, 39, 661, DateTimeKind.Local).AddTicks(4789)
                        });
                });
