...
namespace BIgGameCore.Migrations
{
    ...
    [Migration("20220408124300_VirtualBAsTOBoat")]
    partial class VirtualBAsTOBoat
    {
            ...
            modelBuilder.Entity("BigGame.Models.BoatAvailability", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 15, 14, 42, 59, 921, DateTimeKind.Local).AddTicks(2867),
                            Location = "Budva",
                            Price = 35.5f,
                            StartDate = new DateTime(2022, 4, 8, 14, 42, 59, 917, DateTimeKind.Local).AddTicks(6472)
                        },
                        new
                        {
                            BoatAvailabilityID = 2,
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 22, 14, 42, 59, 921, DateTimeKind.Local).AddTicks(5148),
                            Location = "Budva",
                            Price = 40.5f,
                            StartDate = new DateTime(2022, 4, 15, 14, 42, 59, 921, DateTimeKind.Local).AddTicks(5126)
                        },
                        new
                        {
                            BoatAvailabilityID = 3,
                            BoatID = 4,
                            EndDate = new DateTime(2022, 4, 15, 14, 42, 59, 921, DateTimeKind.Local).AddTicks(5159),
                            Location = "Budva",
                            Price = 15.5f,
                            StartDate = new DateTime(2022, 4, 8, 14, 42, 59, 921, DateTimeKind.Local).AddTicks(5155)
                        },
                        new
                        {
                            BoatAvailabilityID = 4,
                            BoatID = 3,
                            EndDate = new DateTime(2022, 4, 15, 14, 42, 59, 921, DateTimeKind.Local).AddTicks(5168),
                            Location = "Herceg Novi",
                            Price = 20f,
                            StartDate = new DateTime(2022, 4, 8, 14, 42, 59, 921, DateTimeKind.Local).AddTicks(5164)
                        },
                        new
                        {
                            BoatAvailabilityID = 5,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 15, 14, 42, 59, 921, DateTimeKind.Local).AddTicks(5177),
                            Location = "Herceg Novi",
                            Price = 37f,
                            StartDate = new DateTime(2022, 4, 8, 14, 42, 59, 921, DateTimeKind.Local).AddTicks(5173)
                        },
                        new
                        {
                            BoatAvailabilityID = 6,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 25, 14, 42, 59, 921, DateTimeKind.Local).AddTicks(5186),
                            Location = "Budva",
                            Price = 55.2f,
                            StartDate = new DateTime(2022, 4, 15, 14, 42, 59, 921, DateTimeKind.Local).AddTicks(5182)
                        });
                });
