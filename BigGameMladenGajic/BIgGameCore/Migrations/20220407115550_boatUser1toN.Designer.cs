...
namespace BIgGameCore.Migrations
{
    ...
    [Migration("20220407115550_boatUser1toN")]
    partial class boatUser1toN
    {
            ...
            modelBuilder.Entity("BigGame.Models.BoatAvailability", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 14, 13, 55, 49, 696, DateTimeKind.Local).AddTicks(4753),
                            Location = "Budva",
                            Price = 35.5f,
                            StartDate = new DateTime(2022, 4, 7, 13, 55, 49, 692, DateTimeKind.Local).AddTicks(3790)
                        },
                        new
                        {
                            BoatAvailabilityID = 2,
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 21, 13, 55, 49, 696, DateTimeKind.Local).AddTicks(7354),
                            Location = "Budva",
                            Price = 40.5f,
                            StartDate = new DateTime(2022, 4, 14, 13, 55, 49, 696, DateTimeKind.Local).AddTicks(7328)
                        },
                        new
                        {
                            BoatAvailabilityID = 3,
                            BoatID = 4,
                            EndDate = new DateTime(2022, 4, 14, 13, 55, 49, 696, DateTimeKind.Local).AddTicks(7367),
                            Location = "Budva",
                            Price = 15.5f,
                            StartDate = new DateTime(2022, 4, 7, 13, 55, 49, 696, DateTimeKind.Local).AddTicks(7362)
                        },
                        new
                        {
                            BoatAvailabilityID = 4,
                            BoatID = 3,
                            EndDate = new DateTime(2022, 4, 14, 13, 55, 49, 696, DateTimeKind.Local).AddTicks(7377),
                            Location = "Herceg Novi",
                            Price = 20f,
                            StartDate = new DateTime(2022, 4, 7, 13, 55, 49, 696, DateTimeKind.Local).AddTicks(7372)
                        },
                        new
                        {
                            BoatAvailabilityID = 5,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 14, 13, 55, 49, 696, DateTimeKind.Local).AddTicks(7387),
                            Location = "Herceg Novi",
                            Price = 37f,
                            StartDate = new DateTime(2022, 4, 7, 13, 55, 49, 696, DateTimeKind.Local).AddTicks(7382)
                        },
                        new
                        {
                            BoatAvailabilityID = 6,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 24, 13, 55, 49, 696, DateTimeKind.Local).AddTicks(7397),
                            Location = "Budva",
                            Price = 55.2f,
                            StartDate = new DateTime(2022, 4, 14, 13, 55, 49, 696, DateTimeKind.Local).AddTicks(7392)
                        });
                });
