...
namespace BIgGameCore.Migrations
{
    ...
    partial class BigGameContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BIgGameCore.Models.BoatImage", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BigGame.Models.BoatAvailability", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatID = 1,
                            EndDate = new DateTime(2022, 5, 16, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(6996),
                            Location = "Budva",
                            Price = 35.5f,
                            StartDate = new DateTime(2022, 5, 9, 15, 10, 41, 465, DateTimeKind.Local).AddTicks(2470)
                        },
                        new
                        {
                            BoatAvailabilityID = 2,
                            BoatID = 1,
                            EndDate = new DateTime(2022, 5, 23, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(8423),
                            Location = "Budva",
                            Price = 40.5f,
                            StartDate = new DateTime(2022, 5, 16, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(8408)
                        },
                        new
                        {
                            BoatAvailabilityID = 3,
                            BoatID = 4,
                            EndDate = new DateTime(2022, 5, 16, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(8431),
                            Location = "Budva",
                            Price = 15.5f,
                            StartDate = new DateTime(2022, 5, 9, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(8428)
                        },
                        new
                        {
                            BoatAvailabilityID = 4,
                            BoatID = 3,
                            EndDate = new DateTime(2022, 5, 16, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(8437),
                            Location = "Herceg Novi",
                            Price = 20f,
                            StartDate = new DateTime(2022, 5, 9, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(8434)
                        },
                        new
                        {
                            BoatAvailabilityID = 5,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 5, 16, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(8443),
                            Location = "Herceg Novi",
                            Price = 37f,
                            StartDate = new DateTime(2022, 5, 9, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(8440)
                        },
                        new
                        {
                            BoatAvailabilityID = 6,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 5, 26, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(8449),
                            Location = "Budva",
                            Price = 55.2f,
                            StartDate = new DateTime(2022, 5, 16, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(8446)
                        });
                });
            ...
            modelBuilder.Entity("BigGame.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatAvailabilityID = 1,
                            UserID = 1,
                            endDateTime = new DateTime(2022, 5, 11, 15, 10, 41, 468, DateTimeKind.Local).AddTicks(245),
                            startDateTime = new DateTime(2022, 5, 10, 15, 10, 41, 467, DateTimeKind.Local).AddTicks(9933),
                            status = 0
                        },
                        new
                        {
                            ...
                            BoatAvailabilityID = 3,
                            UserID = 2,
                            endDateTime = new DateTime(2022, 5, 11, 15, 10, 41, 468, DateTimeKind.Local).AddTicks(554),
                            startDateTime = new DateTime(2022, 5, 10, 15, 10, 41, 468, DateTimeKind.Local).AddTicks(543),
                            status = 0
                        });
                });
