...
namespace BIgGameCore.Migrations
{
    ...
    [Migration("20220331105600_insertPonude")]
    partial class insertPonude
    {
            ...
            modelBuilder.Entity("BigGame.Models.BoatAvailability", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 7, 12, 55, 59, 558, DateTimeKind.Local).AddTicks(7737),
                            Location = "Budva",
                            Price = 35.5f,
                            StartDate = new DateTime(2022, 3, 31, 12, 55, 59, 556, DateTimeKind.Local).AddTicks(5506)
                        },
                        new
                        {
                            BoatAvailabilityID = 2,
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 14, 12, 55, 59, 558, DateTimeKind.Local).AddTicks(9157),
                            Location = "Budva",
                            Price = 40.5f,
                            StartDate = new DateTime(2022, 4, 7, 12, 55, 59, 558, DateTimeKind.Local).AddTicks(9141)
                        },
                        new
                        {
                            BoatAvailabilityID = 3,
                            BoatID = 4,
                            EndDate = new DateTime(2022, 4, 7, 12, 55, 59, 558, DateTimeKind.Local).AddTicks(9165),
                            Location = "Budva",
                            Price = 15.5f,
                            StartDate = new DateTime(2022, 3, 31, 12, 55, 59, 558, DateTimeKind.Local).AddTicks(9162)
                        },
                        new
                        {
                            BoatAvailabilityID = 4,
                            BoatID = 3,
                            EndDate = new DateTime(2022, 4, 7, 12, 55, 59, 558, DateTimeKind.Local).AddTicks(9171),
                            Location = "Herceg Novi",
                            Price = 20f,
                            StartDate = new DateTime(2022, 3, 31, 12, 55, 59, 558, DateTimeKind.Local).AddTicks(9169)
                        },
                        new
                        {
                            BoatAvailabilityID = 5,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 7, 12, 55, 59, 558, DateTimeKind.Local).AddTicks(9177),
                            Location = "Herceg Novi",
                            Price = 37f,
                            StartDate = new DateTime(2022, 3, 31, 12, 55, 59, 558, DateTimeKind.Local).AddTicks(9174)
                        },
                        new
                        {
                            BoatAvailabilityID = 6,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 17, 12, 55, 59, 558, DateTimeKind.Local).AddTicks(9183),
                            Location = "Budva",
                            Price = 55.2f,
                            StartDate = new DateTime(2022, 4, 7, 12, 55, 59, 558, DateTimeKind.Local).AddTicks(9180)
                        });
                });
