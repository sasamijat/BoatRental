...
namespace BIgGameCore.Migrations
{
    ...
    [Migration("20220505132857_images")]
            ...
            modelBuilder.Entity("BigGame.Models.BoatAvailability", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatID = 1,
                            EndDate = new DateTime(2022, 5, 12, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(4271),
                            Location = "Budva",
                            Price = 35.5f,
                            StartDate = new DateTime(2022, 5, 5, 15, 28, 56, 457, DateTimeKind.Local).AddTicks(1366)
                        },
                        new
                        {
                            BoatAvailabilityID = 2,
                            BoatID = 1,
                            EndDate = new DateTime(2022, 5, 19, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(5745),
                            Location = "Budva",
                            Price = 40.5f,
                            StartDate = new DateTime(2022, 5, 12, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(5729)
                        },
                        new
                        {
                            BoatAvailabilityID = 3,
                            BoatID = 4,
                            EndDate = new DateTime(2022, 5, 12, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(5753),
                            Location = "Budva",
                            Price = 15.5f,
                            StartDate = new DateTime(2022, 5, 5, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(5750)
                        },
                        new
                        {
                            BoatAvailabilityID = 4,
                            BoatID = 3,
                            EndDate = new DateTime(2022, 5, 12, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(5759),
                            Location = "Herceg Novi",
                            Price = 20f,
                            StartDate = new DateTime(2022, 5, 5, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(5757)
                        },
                        new
                        {
                            BoatAvailabilityID = 5,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 5, 12, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(5765),
                            Location = "Herceg Novi",
                            Price = 37f,
                            StartDate = new DateTime(2022, 5, 5, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(5763)
                        },
                        new
                        {
                            BoatAvailabilityID = 6,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 5, 22, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(5771),
                            Location = "Budva",
                            Price = 55.2f,
                            StartDate = new DateTime(2022, 5, 12, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(5768)
                        });
                });
            ...
            modelBuilder.Entity("BigGame.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatAvailabilityID = 1,
                            UserID = 1,
                            endDateTime = new DateTime(2022, 5, 7, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(7472),
                            startDateTime = new DateTime(2022, 5, 6, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(7160),
                            status = 0
                        },
                        new
                        {
                            ...
                            BoatAvailabilityID = 3,
                            UserID = 2,
                            endDateTime = new DateTime(2022, 5, 7, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(7779),
                            startDateTime = new DateTime(2022, 5, 6, 15, 28, 56, 459, DateTimeKind.Local).AddTicks(7768),
                            status = 0
                        });
                });
