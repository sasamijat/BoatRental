...
namespace BIgGameCore.Migrations
{
    ...
    [Migration("20220413102523_ReservationStatus")]
            ...
            modelBuilder.Entity("BigGame.Models.BoatAvailability", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 20, 12, 25, 23, 284, DateTimeKind.Local).AddTicks(7770),
                            Location = "Budva",
                            Price = 35.5f,
                            StartDate = new DateTime(2022, 4, 13, 12, 25, 23, 281, DateTimeKind.Local).AddTicks(53)
                        },
                        new
                        {
                            BoatAvailabilityID = 2,
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 27, 12, 25, 23, 284, DateTimeKind.Local).AddTicks(9431),
                            Location = "Budva",
                            Price = 40.5f,
                            StartDate = new DateTime(2022, 4, 20, 12, 25, 23, 284, DateTimeKind.Local).AddTicks(9413)
                        },
                        new
                        {
                            BoatAvailabilityID = 3,
                            BoatID = 4,
                            EndDate = new DateTime(2022, 4, 20, 12, 25, 23, 284, DateTimeKind.Local).AddTicks(9440),
                            Location = "Budva",
                            Price = 15.5f,
                            StartDate = new DateTime(2022, 4, 13, 12, 25, 23, 284, DateTimeKind.Local).AddTicks(9437)
                        },
                        new
                        {
                            BoatAvailabilityID = 4,
                            BoatID = 3,
                            EndDate = new DateTime(2022, 4, 20, 12, 25, 23, 284, DateTimeKind.Local).AddTicks(9446),
                            Location = "Herceg Novi",
                            Price = 20f,
                            StartDate = new DateTime(2022, 4, 13, 12, 25, 23, 284, DateTimeKind.Local).AddTicks(9443)
                        },
                        new
                        {
                            BoatAvailabilityID = 5,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 20, 12, 25, 23, 284, DateTimeKind.Local).AddTicks(9454),
                            Location = "Herceg Novi",
                            Price = 37f,
                            StartDate = new DateTime(2022, 4, 13, 12, 25, 23, 284, DateTimeKind.Local).AddTicks(9451)
                        },
                        new
                        {
                            BoatAvailabilityID = 6,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 30, 12, 25, 23, 284, DateTimeKind.Local).AddTicks(9461),
                            Location = "Budva",
                            Price = 55.2f,
                            StartDate = new DateTime(2022, 4, 20, 12, 25, 23, 284, DateTimeKind.Local).AddTicks(9458)
                        });
                });
            ...
            modelBuilder.Entity("BigGame.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatAvailabilityID = 1,
                            UserID = 1,
                            endDateTime = new DateTime(2022, 4, 15, 12, 25, 23, 285, DateTimeKind.Local).AddTicks(1552),
                            startDateTime = new DateTime(2022, 4, 14, 12, 25, 23, 285, DateTimeKind.Local).AddTicks(1224),
                            status = 0
                        },
                        new
                        {
                            ...
                            BoatAvailabilityID = 3,
                            UserID = 2,
                            endDateTime = new DateTime(2022, 4, 15, 12, 25, 23, 285, DateTimeKind.Local).AddTicks(1872),
                            startDateTime = new DateTime(2022, 4, 14, 12, 25, 23, 285, DateTimeKind.Local).AddTicks(1861),
                            status = 0
                        });
                });
