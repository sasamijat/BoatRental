...
namespace BIgGameCore.Migrations
{
    ...
    [Migration("20220408145714_addReservation2")]
    partial class addReservation2
    {
            ...
            modelBuilder.Entity("BigGame.Models.BoatAvailability", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 15, 16, 57, 14, 313, DateTimeKind.Local).AddTicks(7638),
                            Location = "Budva",
                            Price = 35.5f,
                            StartDate = new DateTime(2022, 4, 8, 16, 57, 14, 311, DateTimeKind.Local).AddTicks(3200)
                        },
                        new
                        {
                            BoatAvailabilityID = 2,
                            BoatID = 1,
                            EndDate = new DateTime(2022, 4, 22, 16, 57, 14, 313, DateTimeKind.Local).AddTicks(9117),
                            Location = "Budva",
                            Price = 40.5f,
                            StartDate = new DateTime(2022, 4, 15, 16, 57, 14, 313, DateTimeKind.Local).AddTicks(9102)
                        },
                        new
                        {
                            BoatAvailabilityID = 3,
                            BoatID = 4,
                            EndDate = new DateTime(2022, 4, 15, 16, 57, 14, 313, DateTimeKind.Local).AddTicks(9125),
                            Location = "Budva",
                            Price = 15.5f,
                            StartDate = new DateTime(2022, 4, 8, 16, 57, 14, 313, DateTimeKind.Local).AddTicks(9122)
                        },
                        new
                        {
                            BoatAvailabilityID = 4,
                            BoatID = 3,
                            EndDate = new DateTime(2022, 4, 15, 16, 57, 14, 313, DateTimeKind.Local).AddTicks(9131),
                            Location = "Herceg Novi",
                            Price = 20f,
                            StartDate = new DateTime(2022, 4, 8, 16, 57, 14, 313, DateTimeKind.Local).AddTicks(9129)
                        },
                        new
                        {
                            BoatAvailabilityID = 5,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 15, 16, 57, 14, 313, DateTimeKind.Local).AddTicks(9137),
                            Location = "Herceg Novi",
                            Price = 37f,
                            StartDate = new DateTime(2022, 4, 8, 16, 57, 14, 313, DateTimeKind.Local).AddTicks(9135)
                        },
                        new
                        {
                            BoatAvailabilityID = 6,
                            BoatID = 2,
                            EndDate = new DateTime(2022, 4, 25, 16, 57, 14, 313, DateTimeKind.Local).AddTicks(9143),
                            Location = "Budva",
                            Price = 55.2f,
                            StartDate = new DateTime(2022, 4, 15, 16, 57, 14, 313, DateTimeKind.Local).AddTicks(9141)
                        });
                });
            ...
            modelBuilder.Entity("BigGame.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoatAvailabilityID = 1,
                            UserID = 1,
                            endDateTime = new DateTime(2022, 4, 10, 16, 57, 14, 314, DateTimeKind.Local).AddTicks(920),
                            startDateTime = new DateTime(2022, 4, 9, 16, 57, 14, 314, DateTimeKind.Local).AddTicks(615)
                        },
                        new
                        {
                            ReservationID = 2,
                            BoatAvailabilityID = 3,
                            UserID = 2,
                            endDateTime = new DateTime(2022, 4, 10, 16, 57, 14, 314, DateTimeKind.Local).AddTicks(1219),
                            startDateTime = new DateTime(2022, 4, 9, 16, 57, 14, 314, DateTimeKind.Local).AddTicks(1209)
                        });
                });
